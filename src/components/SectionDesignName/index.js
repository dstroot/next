...
const SectionDesignName = () => {
  return (
    <div className="py-6">
      ...
      <p>Our products adapt to your life’s biggest moments. Change them when your needs do.</p>
      <h2>Radically Simple</h2>
      <p>Straight forward products and features. Know what you're getting from the beginning.</p>
