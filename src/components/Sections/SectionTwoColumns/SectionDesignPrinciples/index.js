      ...
      <div>
        <div id="scrollStarts">
          <SectionTwoColumns
            ...
            contentRight={
              <div className="m-5">
                <div className="para mt-5" ref={div => (this.para1 = div)}>
                ...
                <div className="para mt-5" ref={div => (this.para2 = div)}>
                ...
                <div className="para mt-5" ref={div => (this.para3 = div)}>
                ...
                <div className="para mt-5" ref={div => (this.para4 = div)}>
                ...
                <div className="para mt-5" ref={div => (this.para5 = div)}>
