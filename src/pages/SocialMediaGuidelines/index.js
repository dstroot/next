  ...
  return (
    <Disclaimer
      ...
      content={
        <div>
          <p>
            Please read the following guidelines to ensure a safe and productive
            experience. The insurance and investment industries are highly
            regulated; therefore, we cannot engage in discussions on social
            forums about our products, services, or solutions.
          </p>
          <p>
            ...
            photos and video posted by fans or followers do not represent those
            of Pacific Life. We reserve the right to moderate and delete any
            post, comment, content, etc. at any time and without notice if it is
            violation of the following terms of use. Pacific Life reserves the
            right to ban users without notice or consent. We will consistently
            monitor the sites to ensure the guidelines below are being followed.
          ...
          <ul>
            ...
            <li>
              ...
              commercial, financial, political or governmental organization. Our
              social media pages are not for the endorsement of third parties
              and these posts will be removed.
            </li>
          </ul>
          <p>
            <u>
              Here are some best practices to keep in mind to ensure your post,
              comment or message will not be deleted:
            </u>
          </p>
          <ul>
            <li>
            ...
            <li>
              Please stay on topic so that the conversation can remain relevant.
              Use common courtesy within our community and share your opinions
              and feedback in a respectful manner.
            </li>
          </ul>
          <p>
            ...
            via social media. We may post information to third party sites if we
            find the information useful or relevant but this does not constitute
            an official endorsement or recommendation on behalf of Pacific Life.
            Any content, including posts, responses, and videos, on our social
            media sites should not be considered as an advertisement,
          ...
          <p>
            ...
            personal, confidential, and financial information via social media.
            Keep your personal information secure and private. Pacific Life does
            not participate in online lotteries and is not involved in the
            ...
            personal or financial information, DO NOT RESPOND or click any links
            in the email. If you have any concerns about a message that you have
            received, please call the Pacific Life Privacy toll-free number
            (877) 722-7848.
          </p>
          <p>
            Social media sites are not affiliated with Pacific Life; please
            review privacy policies and terms of service for each site. By going
            to these sites you assume risk of use.
          </p>
          <p className="ml-5">
            <a
              target="_blank"
          ...
          <p>
            ...
            PublicAffairs@PacificLife.com . Please note we cannot reply to every
            comment or message. Pacific Life cannot answer customer service
            related questions via social media. Social media should not be used
            for the submission of any claim, complaint, or product inquiry.
            Please refer to our website for contact information.
          </p>
          <p>
            For more than 150 years, Pacific Life has been helping individuals
            and families with a portfolio of insurance products, annuities, and
            mutual funds. Thank you for your interest in our brand.
          </p>
        </div>
      }
    />
